...
namespace   // Hiding the Helping Functions in a Namespace
{
...
//Uses iostream:
    istream &operator>>(istream &ins, DigitalTime &theObject) {  // Within the compilation unit (in this case dtime.cpp), you can use names in the unnamed namespace without qualification.
