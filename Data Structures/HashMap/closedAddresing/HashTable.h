...
#ifndef CLOSEDADDRESING_HASHTABLE_H
#define CLOSEDADDRESING_HASHTABLE_H
...
public:
    ...
    void Insert(int k, int v) {
        ...
        int delindex = -1;
        while (hash_val != init &&
               (ht[hash_val] == DelNode::getNode() || ht[hash_val] != NULL && ht[hash_val]->k != k)) {
            if (init == -1)
                init = hash_val;
...
#endif //CLOSEDADDRESING_HASHTABLE_H
